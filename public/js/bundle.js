  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(email, password) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          console.log("probaganda");
          _context.next = 4;
          return (0, _axios.default)({
            method: "POST",
            url: "http://localhost:18000/api/v1/users/login",
            data: {
              email: email,
              password: password
            }
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          ...
          return (0, _axios.default)({
            method: "GET",
            url: "http://localhost:18000/api/v1/users/logout"
          });
        case 3:
          res = _context2.sent;
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(data, type) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          url = type === "password" ? "http://localhost:18000/api/v1/users/updateMyPassword" : "http://localhost:18000/api/v1/users/updateMe";
          _context.next = 4;
          return (0, _axios.default)({
            method: "PATCH",
            url: url,
